...
public class SignupThree extends JFrame implements ActionListener{
    ...
    public SignupThree(String formno) {
        ...
        c1.setFont(new Font("Raieway",Font.BOLD,16));
        c1.setBounds(100, 500, 200, 30);
        add(c1);
        
        c2=new JCheckBox("Internet Banking");
        c2.setBackground(Color.WHITE);
        c2.setFont(new Font("Raieway",Font.BOLD,16));
        c2.setBounds(350, 500, 200, 30);
        add(c2);
        
        c3=new JCheckBox("Mobile Banking");
        c3.setBackground(Color.WHITE);
        c3.setFont(new Font("Raieway",Font.BOLD,16));
        c3.setBounds(100, 550, 200, 30);
        add(c3);
        
        c4=new JCheckBox("EMAIL & SMS Alerts");
        c4.setBackground(Color.WHITE);
        c4.setFont(new Font("Raieway",Font.BOLD,16));
        c4.setBounds(350, 550, 200, 30);
        add(c4);
        
        c5=new JCheckBox("Cheque Book");
        c5.setBackground(Color.WHITE);
        c5.setFont(new Font("Raieway",Font.BOLD,16));
        c5.setBounds(100, 600, 200, 30);
        add(c5);
        
        c6=new JCheckBox("AE-Satement");
        c6.setBackground(Color.WHITE);
        c6.setFont(new Font("Raieway",Font.BOLD,16));
        c6.setBounds(350, 600, 200, 30);
        add(c6);
        
        c7=new JCheckBox("Hereby declares that above entered details are to the best of my knowledge");
        c7.setBackground(Color.WHITE);
        c7.setFont(new Font("Raieway",Font.BOLD,12));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==submit){
            ...
            if(r1.isSelected()){
             ...
             accountType ="Requring Deposit Account";
            }
